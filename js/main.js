...
function documentReadyInit() {
	...
	$('form.searchform, form.search-form').on('submit', function( e ){
		...
		$searchModal.modal('show'); // Aquí muestras el modal de la búsqueda 
		// & desabilitamos la consulta php | chendo-->
		...
		// 	})
		// 	.fail(function( data ) {
		// 		$searchModal.append('<div class="searchform-respond">Resultados de búsqueda</div>');
